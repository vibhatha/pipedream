...
class Stage1(torch.nn.Module):
    def __init__(self):
        ...
        self.layer15 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        self.layer21 = torch.nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.layer24 = torch.nn.Linear(in_features=25088, out_features=4096, bias=True)
        self.layer25 = torch.nn.ReLU(inplace=True)
        self.layer26 = torch.nn.Dropout(p=0.5)
        self.layer27 = torch.nn.Linear(in_features=4096, out_features=4096, bias=True)
        self.layer28 = torch.nn.ReLU(inplace=True)
        self.layer29 = torch.nn.Dropout(p=0.5)
        self.layer30 = torch.nn.Linear(in_features=4096, out_features=1000, bias=True)
